...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden shrink-0 bg-card lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-56 lg:flex-col lg:gap-1 lg:px-4 lg:py-6 lg:shadow-[1px_0_0_var(--border)]">
